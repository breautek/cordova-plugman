...
module.exports = {
    async install (cli_opts) {
        ...
        for (let i = 0; i < cli_opts.plugin.length; i++) {
            await plugman.install(cli_opts.platform, cli_opts.project, cli_opts.plugin[i], cli_opts.plugins_dir, opts);
        }
    ...
    async uninstall (cli_opts) {
        ...
        for (let i = 0; i < cli_opts.plugin.length; i++) {
            await plugman.uninstall(cli_opts.platform, cli_opts.project, cli_opts.plugin[i], cli_opts.plugins_dir, opts);
        }
